...
#SIMULATE WITH CAMERA
	...
	$(sleep 5 ; mv $AEROSTACK_WORKSPACE/develIgnore $AEROSTACK_WORKSPACE/devel) & roslaunch px4 mavros_posix_sitl.launch world:=${APPLICATION_PATH}/configs/gazebo_files/worlds/lidar_example.world vehicle:=iris sdf:=${APPLICATION_PATH}/configs/gazebo_files/models/iris_rplidar/iris_rplidar.sdf respawn_gazebo:=true
